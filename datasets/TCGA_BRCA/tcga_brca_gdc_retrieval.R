...
# That is the only way for GDCdownload() to download the query files. 
...
# retrieve gene expression counts data of all types
...
write.csv(geneExp_unstranded,'geneExp_unstranded.csv')
write.csv(geneExp_tpm_unstrand,'geneExp_tpm_unstrand.csv')
write.csv(geneExp_fpkm_unstrand,'geneExp_fpkm_unstrand.csv')
