...
actual_label_plot = actual_survivalPlot(df = counts_res, 
                                 ...
                                 alive_indicator = 0, 
                                 plot_title = "SCAN-B NextSeq Test Set \n with Actual Subtype Labels (n=276)")

print(actual_label_plot)
ggsave(actual_label_plot$plot, filename = "scanb_nextseq_test_actual_labels_survival.png", 
...
counts_rf_plot = predicted_survivalPlot(df = counts_res, 
                                        survival_event = "overall_survival_event", 
                                        alive_indicator = 0, 
                                        plot_title = "SCAN-B NextSeq Test Set \n with Counts-RF Predicted Labels (n=276)")
...
word2vec_svm_plot = predicted_survivalPlot(df = word2vec_res, 
                                       survival_event = "overall_survival_event", 
                                       alive_indicator = 0, 
                                       plot_title = "SCAN-B NextSeq Test Set \n with Word2vec-SVM Predicted Labels (n=276)")
print(word2vec_svm_plot)

ggsave(word2vec_svm_plot$plot, filename = "scanb_nextseq_test_word2vec_svm_labels_survival.png", 
       dpi = 300, height = 7, width = 8)
