...
# remove patients with survival years greater than 10, because that is when the plateau starts
...
actual_label_plot = actual_survivalPlot(df = counts_res_filtered, 
                                 ...
                                 plot_title = "TCGA-BRCA Test Set \n with Actual Subtype Labels (n=991)")

print(actual_label_plot)
ggsave(actual_label_plot$plot, filename = "tcga_brca_actual_labels_survival.png", 
...
counts_rf_plot = predicted_survivalPlot(df = counts_res_filtered, 
                                        survival_event = "vital_status", 
                                        alive_indicator = "Alive", 
                                        plot_title = "TCGA-BRCA Test Set with \n Counts-RF Predicted Labels (n=991)")
...
rank_svm_plot = predicted_survivalPlot(df = rank_res_filtered, 
                                            survival_event = "vital_status", 
                                            alive_indicator = "Alive", 
                                            plot_title = "TCGA-BRCA Test Set \n with Rank-SVM Predicted Labels (n=991)")
print(rank_svm_plot)

ggsave(rank_svm_plot$plot, filename = "tcga_brca_rank_svm_labels_survival.png", 
       dpi = 300, height = 7, width = 8)
...
word2vec_svm_plot = predicted_survivalPlot(df = word2vec_res_filtered, 
                                       survival_event = "vital_status", 
                                       alive_indicator = "Alive", 
                                       plot_title = "TCGA-BRCA Test Set \n with Word2vec-SVM Predicted Labels (n=991)")
print(word2vec_svm_plot)

ggsave(word2vec_svm_plot$plot, filename = "tcga_brca_word2vec_svm_labels_survival.png", 
       dpi = 300, height = 7, width = 8)
